...
//        //robot 1
        ...
        cout<<"robot 1"<<endl;
        cout<<"Nearest: "<<robot1.nearest_robot_x<<","<<robot1.nearest_robot_y<<endl;
        ...
        moves.avoid_collisions(robot1, sim_proxy, forward_speed, turning_speed);
        robot1.set_motors(forward_speed, turning_speed);
        
        //robot 2
        c.broadcast(robot2, sim_proxy);
        cout<<"robot 2"<<endl;
        cout<<"Nearest: "<<robot2.nearest_robot_x<<","<<robot2.nearest_robot_y<<endl;
        ...
        moves.avoid_collisions(robot2, sim_proxy, forward_speed2, turning_speed2);
        robot2.set_motors(forward_speed2, turning_speed2);
        
//        //robot 3
        c.broadcast(robot3, sim_proxy);
        cout<<"robot 3"<<endl;
        cout<<"Nearest: "<<robot3.nearest_robot_x<<","<<robot3.nearest_robot_y<<endl;
        ...
        moves.avoid_collisions(robot3, sim_proxy, forward_speed3, turning_speed3);
        robot3.set_motors(forward_speed3, turning_speed3);
        
        //robot 4
        c.broadcast(robot4, sim_proxy);
        cout<<"robot 4"<<endl;
        cout<<"Nearest: "<<robot4.nearest_robot_x<<","<<robot4.nearest_robot_y<<endl;
        ...
        moves.avoid_collisions(robot4, sim_proxy, forward_speed4, turning_speed4);
